...
const char* ssid = "INFINITUM3759";          // Nombre de la red WiFi
const char* password = "HQ2JC2hvFM";        // Contraseña de la red Wifi
const char* mqtt_server = "192.168.1.89";   // Red local (ifconfig en terminal) -> broker MQTT
IPAddress server(192,168,1,89);             // Red local (ifconfig en terminal) -> broker MQTT
...
void setup() {// Inicio de void setup()
  ...
  Serial.println("Direccion IP: http://");
  Serial.println(WiFi.localIP());
  Serial.println("Estado de la conexion: ");
...
timeNow5 = millis(); // Control de tiempo para esperas no bloqueantes
  ...
  if (timeNow5 - timeLast5 > wait5) { 
    ...
    client.publish("STHumedadG6", humeString);  // Envía Humedad Rel por MQTT, especifica el tema y el valor
